...
import { github, pnglogo } from '../assets';
        ...
        <div className="md:hidden flex flex-1 justify-end items-center">
          ...
          <div className={`${toggle ? "translate-x-0 opacity-100" : "translate-x-32 opacity-0"} transition-all flex p-6 black-gradient absolute top-20 right-0 my-2 mx-4 min-w-[140px] z-10 rounded-sm`}>
            <ul className='list-none flex flex-col items-start gap-4'>
              {linkElements}
              <li>
                <a className='flex items-center flex-row-reverse gap-1' href="https://github.com/sika-007">
                  <img src={github} alt="github" className='w-7 h-7' />
                  <p className=' text-secondary font-poppins sm:hover:text-white sm:text-[18px] font-medium'>Github</p>
                </a>
              </li>
            </ul>
          </div>
